...
; All other cases are neutral (1x).
	...
	db FLYPRESS,  NORMAL,	 SUPER_EFFECTIVE
	db FLYPRESS,  ELECTRIC,  NOT_VERY_EFFECTIVE
	db FLYPRESS,  GRASS,	 SUPER_EFFECTIVE
	db FLYPRESS,  ICE,	 SUPER_EFFECTIVE
	db FLYPRESS,  FIGHTING,	 SUPER_EFFECTIVE
	db FLYPRESS,  POISON,	 NOT_VERY_EFFECTIVE
	db FLYPRESS,  FLYING,	 NOT_VERY_EFFECTIVE
	db FLYPRESS,  PSYCHIC,	 NOT_VERY_EFFECTIVE
	db FLYPRESS,  GHOST,	 NO_EFFECT
	db FLYPRESS,  DARK,	 SUPER_EFFECTIVE
	db FLYPRESS,  FAIRY,	 NOT_VERY_EFFECTIVE
