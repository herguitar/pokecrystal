const_value set 2
	...
	const PEWTERPOKECENTER1F_FROSLASS
...
.PersonEvents:
	...
	person_event SPRITE_FROSLASS, 3, 1, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, PewterJigglypuff, -1
