const_value set 2
	...
	const BLACKTHORNDRAGONSPEECHHOUSE_VIKAVOLT
...
.PersonEvents:
	...
	person_event SPRITE_VIKAVOLT, 5, 5, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, Dratini, -1
