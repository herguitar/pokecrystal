const_value set 2
	...
	const TEAMROCKETBASEB3F_RELICANTH
...
LanceGetPasswordScript:
	...
	pause 5
	spriteface TEAMROCKETBASEB3F_RELICANTH, RIGHT
	pause 20
...
GruntM28Script:
	...
	waitbutton
	closetext
	setevent EVENT_LEARNED_ARAQUANID_TAIL
	end
...
.Script:
	...
	checkevent EVENT_LEARNED_ARAQUANID_TAIL
	iffalse .NeedsPassword
	jump .OpenSesame
...
.PersonEvents:
	...
	person_event SPRITE_RELICANTH, 2, 7, SPRITEMOVEDATA_POKEMON, 0, 0, -1, -1, (1 << 3) | PAL_OW_BLUE, PERSONTYPE_SCRIPT, 0, RocketBaseMurkrow, EVENT_TEAM_ROCKET_BASE_POPULATION
