...
.Warps:
	...
	warp_def $3, $f, 3, RUINS_OF_ALPH_LITWICK_CHAMBER
	warp_def $3, $10, 4, RUINS_OF_ALPH_LITWICK_CHAMBER
	warp_def $15, $3, 3, RUINS_OF_ALPH_BRAVIARY_CHAMBER
	warp_def $15, $4, 4, RUINS_OF_ALPH_BRAVIARY_CHAMBER
