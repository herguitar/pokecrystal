...
BattleTowerMons1:
	...
	db CHANDELURE
	db MIRACLEBERRY
	db HEADBUTT, PROTECT, HURRICANE, SURF
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons2:
	...
	db CLAWITZER
	db BRIGHTPOWDER
	db PSYCHIC_M, SUBMISSION, FLARE_BLITZ, COUNTER
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db VULLABY
	db GOLD_BERRY
	db THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, DRAGON_PULSE
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons3:
	...
	db POLIWRATH
	db BRIGHTPOWDER
	db DOUBLE_TEAM, SURF, DRAGON_CLAW, SUBMISSION
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db BRONZONG
	db GOLD_BERRY
	db BLIZZARD, DARK_PULSE, DREAM_EATER, ATTRACT
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db CLAWITZER
	db LEFTOVERS
	db TOXIC, REFLECT, FLARE_BLITZ, PROTECT
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db KROKOROK
	db THICK_CLUB
	db EARTHQUAKE, RETURN, HYPER_BEAM, FREEZE_DRY
	dw 0 ; OT ID
	dt 27000 ; Exp
	; Stat exp
	bigdw 45000
...
BattleTowerMons4:
	...
	db GOLEM
	db FOCUS_BAND
	db EXPLOSION, EARTHQUAKE, DRAGON_PULSE, ROCK_SLIDE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 45000
	...
	db HONCHKROW
	db BRIGHTPOWDER
	db ANCHOR_SHOT, STOMP, PSYCH_UP, CONFUSION
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db MISMAGIUS
	db KINGS_ROCK
	db LIGHT_SCREEN, THUNDERPUNCH, SWIFT, HURRICANE
	dw 0 ; OT ID
	dt 64000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons6:
	...
	db CLAWITZER
	db LEFTOVERS
	db FLARE_BLITZ, TOXIC, PROTECT, PSYCHIC_M
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 50000
	...
	db GLALIE
	db SCOPE_LENS
	db EARTHQUAKE, SLASH, HYPER_BEAM, HURRICANE
	dw 0 ; OT ID
	dt 216000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons7:
	...
	db CLAWITZER
	db GOLD_BERRY
	db COUNTER, FLARE_BLITZ, SHADOW_BALL, THUNDERBOLT
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db KROOKODILE
	db FOCUS_BAND
	db REVERSAL, ENDURE, BODY_SLAM, DRAIN_PUNCH
	dw 0 ; OT ID
	dt 343000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons8:
	...
	db CHANDELURE
	db LEFTOVERS
	db REST, BELLY_DRUM, HURRICANE, EARTHQUAKE
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 60000
	...
	db BRONZONG
	db QUICK_CLAW
	db DARK_PULSE, BLIZZARD, DREAM_EATER, PSYCHIC_M
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 55000
	...
	db RELICANTH
	db CHARCOAL
	db FLAMETHROWER, IRON_HEAD, STEEL_WING, HYPER_BEAM
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons9:
	...
	db CLAWITZER
	db LEFTOVERS
	db SOLARBEAM, SUNNY_DAY, FLARE_BLITZ, FIRE_BLAST
	dw 0 ; OT ID
	dt 729000 ; Exp
	; Stat exp
	bigdw 50000
...
BattleTowerMons10:
	...
	db CLAWITZER
	db LEFTOVERS
	db THUNDERBOLT, BLIZZARD, FIRE_BLAST, FLARE_BLITZ
	dw 0 ; OT ID
	dt 1000000 ; Exp
	; Stat exp
	bigdw 50000
