...
MysteryGiftDecos: ; 2c74a
	...
	db DECOFLAG_SURSKIT_DOLL
	db DECOFLAG_VOLCARONA_DOLL
	db DECOFLAG_COMBEE_DOLL
	db DECOFLAG_POLIWAG_DOLL
	db DECOFLAG_SYLVEON_DOLL
	db DECOFLAG_STARMIE_DOLL
	db DECOFLAG_MAGIKARP_DOLL
	db DECOFLAG_MAMOSWINE_DOLL
	db DECOFLAG_GENGAR_DOLL
	db DECOFLAG_CLEFAIRY_POSTER
	db DECOFLAG_FROSLASS_POSTER
	db DECOFLAG_SNES
	db DECOFLAG_ELEKTRIK_DOLL
