...
.ornaments ; 2692d
	...
	db DECO_FROSLASS_DOLL ; 21
	db DECO_SURSKIT_DOLL ; 22
	db DECO_VOLCARONA_DOLL ; 23
	db DECO_COMBEE_DOLL ; 24
	db DECO_POLIWAG_DOLL ; 25
	db DECO_SYLVEON_DOLL ; 26
	db DECO_STARMIE_DOLL ; 27
	db DECO_MAGIKARP_DOLL ; 28
	db DECO_MAMOSWINE_DOLL ; 29
	db DECO_GENGAR_DOLL ; 2a
	db DECO_ELEKTRIK_DOLL ; 2b
	db DECO_LUXRAY_DOLL ; 2c
...
.big_dolls ; 26955
	db DECO_BIG_CHANDELURE_DOLL ; 1a
...
DecorationAttributes: ; 26a4f
	...
	decoration DECO_POSTER,   FROSLASS,        SET_UP_POSTER,      EVENT_DECO_POSTER_3,               $25
	...
	decoration DECO_BIGDOLL,  CHANDELURE,           SET_UP_BIG_DOLL,    EVENT_DECO_BIG_CHANDELURE_DOLL,       SPRITE_BIG_CHANDELURE
	...
	decoration DECO_DOLL,     FROSLASS,        SET_UP_DOLL,        EVENT_DECO_FROSLASS_DOLL,        SPRITE_FROSLASS
	decoration DECO_DOLL,     SURSKIT,         SET_UP_DOLL,        EVENT_DECO_SURSKIT_DOLL,         SPRITE_SURSKIT
	decoration DECO_DOLL,     VOLCARONA,        SET_UP_DOLL,        EVENT_DECO_VOLCARONA_DOLL,        SPRITE_VOLCARONA
	decoration DECO_DOLL,     COMBEE,          SET_UP_DOLL,        EVENT_DECO_COMBEE_DOLL,          SPRITE_COMBEE
	decoration DECO_DOLL,     POLIWAG,           SET_UP_DOLL,        EVENT_DECO_POLIWAG_DOLL,           SPRITE_POLIWAG
	decoration DECO_DOLL,     SYLVEON,           SET_UP_DOLL,        EVENT_DECO_SYLVEON_DOLL,           SPRITE_SYLVEON
	...
	decoration DECO_DOLL,     MAMOSWINE,            SET_UP_DOLL,        EVENT_DECO_MAMOSWINE_DOLL,            SPRITE_MAMOSWINE
	decoration DECO_DOLL,     GENGAR,            SET_UP_DOLL,        EVENT_DECO_GENGAR_DOLL,            SPRITE_GENGAR
	decoration DECO_DOLL,     ELEKTRIK,          SET_UP_DOLL,        EVENT_DECO_ELEKTRIK_DOLL,          SPRITE_ELEKTRIK
	decoration DECO_DOLL,     LUXRAY,            SET_UP_DOLL,        EVENT_DECO_LUXRAY_DOLL,            SPRITE_LUXRAY
...
DecorationDesc_PosterPointers: ; 26f84
	...
	dbw DECO_FROSLASS_POSTER, DecorationDesc_JigglypuffPoster
	db -1
; 26f91
...
.JigglypuffPosterText: ; 0x26fb3
	; It's a poster of a cute FROSLASS.
