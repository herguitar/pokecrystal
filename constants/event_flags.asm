...
; Johto story events
	...
	const EVENT_GOT_FLYGON_EGG_FROM_ELMS_AIDE
	...
	const EVENT_FLYGON_HATCHED
	const EVENT_SHOWED_FLYGON_TO_ELM
	...
	const EVENT_GOT_SKIDDO_FROM_KIYO
	...
	const EVENT_TOLD_ELM_ABOUT_FLYGON_OVER_THE_PHONE
...
; Kanto Signpost Items
	const EVENT_SYLVEONS_CAVE_HIDDEN_MAX_REVIVE
...
; Ruins Of Alph puzzles
	...
	const EVENT_SOLVED_LITWICK_PUZZLE
	const EVENT_SOLVED_BRAVIARY_PUZZLE
...
; Decorations
	...
	const EVENT_DECO_FROSLASS_DOLL
	const EVENT_DECO_SURSKIT_DOLL
	const EVENT_DECO_VOLCARONA_DOLL
	const EVENT_DECO_COMBEE_DOLL
	const EVENT_DECO_POLIWAG_DOLL
	const EVENT_DECO_SYLVEON_DOLL
	const EVENT_DECO_STARMIE_DOLL ; 2c0
	const EVENT_DECO_MAGIKARP_DOLL
	const EVENT_DECO_MAMOSWINE_DOLL
	const EVENT_DECO_GENGAR_DOLL
	const EVENT_DECO_ELEKTRIK_DOLL
	const EVENT_DECO_LUXRAY_DOLL
	...
	const EVENT_DECO_BIG_CHANDELURE_DOLL
...
; More Johto events
	...
	const EVENT_LEARNED_ARAQUANID_TAIL
	...
	const EVENT_SHOWED_MANDIBUZZ_TO_BILLS_GRANDPA
	const EVENT_SHOWED_MAMOSWINE_TO_BILLS_GRANDPA
	const EVENT_SHOWED_STARYU_TO_BILLS_GRANDPA
	const EVENT_SHOWED_GROWLITHE_VULPIX_TO_BILLS_GRANDPA
	const EVENT_SHOWED_SALAMENCE_TO_BILLS_GRANDPA
...
; More Crystal-specific events
	...
	const EVENT_WALL_OPENED_IN_LITWICK_CHAMBER
	const EVENT_WALL_OPENED_IN_BRAVIARY_CHAMBER
...
; Johto people
	...
	const EVENT_CHARCOAL_KILN_MIENSHAO
	...
	const EVENT_RUINS_OF_ALPH_LITWICK_CHAMBER_RECEPTIONIST
	const EVENT_OPENED_MT_SILVER
	const EVENT_FOUGHT_CHANDELURE ; 750
...
; Kanto people
	...
	const EVENT_VERMILION_CITY_CHANDELURE ; 770
...
; New to Crystal
	...
	const EVENT_PICKED_UP_BERRY_FROM_LITWICK_ITEM_ROOM
	const EVENT_PICKED_UP_PSNCUREBERRY_FROM_LITWICK_ITEM_ROOM
	const EVENT_PICKED_UP_HEAL_POWDER_FROM_LITWICK_ITEM_ROOM
	const EVENT_PICKED_UP_ENERGYPOWDER_FROM_LITWICK_ITEM_ROOM
	const EVENT_PICKED_UP_MYSTERYBERRY_FROM_BRAVIARY_ITEM_ROOM
	const EVENT_PICKED_UP_MYSTIC_WATER_FROM_BRAVIARY_ITEM_ROOM
	const EVENT_PICKED_UP_STARDUST_FROM_BRAVIARY_ITEM_ROOM
	const EVENT_PICKED_UP_STAR_PIECE_FROM_BRAVIARY_ITEM_ROOM
