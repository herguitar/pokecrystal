...
__enum__ = 0
	...
	const BIG_DOLLS
	deco  BIG_CHANDELURE_DOLL ; 1a (13)
	...
	deco  FROSLASS_DOLL ; 21 (19)
	deco  SURSKIT_DOLL ; 22 (1a)
	deco  VOLCARONA_DOLL ; 23 (1b)
	deco  COMBEE_DOLL ; 24 (1c)
	deco  POLIWAG_DOLL ; 25 (1d)
	deco  SYLVEON_DOLL ; 26 (1e)
	deco  STARMIE_DOLL ; 27 (1f)
	deco  MAGIKARP_DOLL ; 28 (20)
	deco  MAMOSWINE_DOLL ; 29 (21)
	deco  GENGAR_DOLL ; 2a (22)
	deco  ELEKTRIK_DOLL ; 2b (23)
	deco  LUXRAY_DOLL ; 2c (24)
