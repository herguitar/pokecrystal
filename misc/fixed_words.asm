...
.a:			db VIKAVOLT, WEAVILE, SEAKING, SALAZZLE, CROCONAW, UNOWN
			db -1
.i:			db EEVEE, GEODUDE, SALANDIT, PILOSWINE, ONIX
			db -1
.u:			db ARCANINE, SUDOWOODO, WEEPINBELL, VICTREEBEL, WOOPER, SWINUB
			db -1
.e:			db SKARMORY, BUDEW, ESPEON, VULLABY, MILOTIC, MISMAGIUS, ENTEI
			db -1
.o:			db FERALIGATR, LYCANROC_N, OCTILLERY, MIENFOO, LYCANROC_D, STANTLER, GRUBBIN, CHARJABUG, YAMASK, BRAVIARY
			db -1
.ka_ga		db GROWLITHE, MACHAMP, DRAGONITE, PINSIR, CHANDELURE, LITWICK, LAMPENT, GOGOAT, VESPIQUEEN, DURANT, MIENSHAO, SANDILE, KROKOROK, KANGASKHAN
			db -1
.ki_gi		db ROSERADE, CATERPIE, GYARADOS, RAPIDASH, NINETALES, SWAMPERT, GARBADOR, KINGDRA, CORPHISH
			db -1
.ku_gu		db MAWILE, HIPPOPOTAS, CHINGLING, SABLEYE, GRANBULL, CROBAT
			db -1
.ke_ge		db ABRA, GENGAR, RUFFLET
			db -1
.ko_go		db MAGIKARP, MAGNEMITE, GASTLY, HAUNTER, MACHOKE, KAKUNA, HAWLUCHA, PHANPY, DEWPIDER, CROAGUNK, GOLBAT, GOLEM, GRAVELER, SWIRLIX
			db -1
.sa_za		db RHYHORN, ELKENTHAL, CORSOLA, KROOKODILE, CARRACOSTA, JOLTEON, SNORUNT, GLALIE ; RHYDON should lead this list
			db -1
.shi_ji	db SEADRA, ELEKTRIK, VAPOREON, LUXIO
			db -1
.su_zu		db SUICUNE, STARMIE, SCYTHER, ZUBAT, BEEDRILL, MIGHTYENA, POOCHYENA
			db -1
.se_ze		db COMBEE, COFAGRIGUS
			db -1
.so_zo		db MARSHTOMP
			db -1
.ta_da		db MIMIKYU, HORSEA, CRAWDAUNT
			db -1
.chi_dhi	db CHIKORITA, BAGON
			db -1
.tsu_du	db ELGYEM
			db -1
.te_de		db SYLVEON, REMORAID, LOMBRE, HOUNDOUR, AMPHAROS
			db -1
.to_do		db STUFFUL, BEWEAR, TROPIUS, BELDUM, TENTACRUEL, TRUBBISH, FLYGON, GOLDEEN, METAPOD, DONPHAN
			db -1
.na		db MAMOSWINE, HONCHKROW
			db -1
.ni		db NIDOKING, NIDOQUEEN, NIDORAN_M, NIDORAN_F, NIDORINA, NIDORINO, MEDITITE, SNEASEL, POLIWHIRL, POLITOED, POLIWRATH, POLIWAG
			db -1
.nu		db QUAGSIRE
			db -1
.ne		db NATU, XATU
...
.no		db DUNSPARCE
			db -1
.ha_ba_pa	db SHINX, STEELIX, TYPHLOSION, DRAGONAIR, BUTTERFREE, SCIZOR, HOPPIP, CLAWITZER, SPRITZEE, SPRITZEE, BRUXISH, BRONZOR, SKIDDO, ELEKTROSS, NUMENTHUR
			db -1
.hi_bi_pi	db TRAPINCH, WEEDLE, PIKACHU, CLEFABLE, PIDGEOT, PIDGEOTTO, SALAMENCE, CLEFAIRY, VOLCARONA, STARYU, CYNDAQUIL, ROSELIA, BEHEYEEM, VOLTORB
			db -1
.fu_bu_pu	db RELICANTH, FLAREON, ALAKAZAM, DHELMISE, HIPPOWDON, GLACEON, MASQUERAIN, SURSKIT, LARVESTA, AERODACTYL, CLAUNCHER, VIBRAVA, UMBREON, TIRTOUGA, FROSLASS, SNUBBULL
			db -1
.he_be_pe	db BAYLEEF, LUXRAY, TYNAMO, HERACROSS, HOUNDOOM, MEDICHAM, MANDIBUZZ
			db -1
.ho_bo_po	db HO_OH, DARUMAKA, PIDGEY, PONYTA, SKIPLOOM, PORYGON, PORYGON2
			db -1
.ma		db LOTAD, TANGROWTH, QUILAVA, BELLSPROUT, METANG, MARILL, TOXAPEX, ELECTRODE, TOXICROAK, LUDICOLO
			db -1
.mi		db DRATINI, MEW, RHYPERIOR, MILTANK
			db -1
.mu		db MISDREAVUS, FEEBAS
			db -1
.me		db MEGANIUM, DITTO, TENTACOOL, MAREEP
			db -1
.mo		db FLAAFFY, SLURPUFF, TANGELA
			db -1
.ya		db SLOWKING, SLOWBRO, SLOWPOKE, MURKROW, MUDKIP
			db -1
.yu		db KADABRA
			db -1
.yo		db PORYGONZ, DARMANITAN
			db -1
.ra		db RAIKOU, ABOMASNOW, METAGROSS, ARAQUANID, LAPRAS, KLEFKI, SHELGON
			db -1
.ri		db SKORUPI, DRAPION, SIGILYPH
			db -1
.ru		db BRONZONG, LUGIA
			db -1
.re		db MAGNETON, TURTONATOR, DARM_ZEN
			db -1
.ro		db VULPIX
			db -1
